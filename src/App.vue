<template>
  ...
  <footer>
    ...
    <a v-if="icpNumber" href="https://icp.gov.moe/?keyword=20259980" target="_blank">{{ icpNumber }}</a>
    <a v-if="policenumber" :href="`https://icp.gov.moe/?keyword=20259980`" target="_blank" class="police_link">
